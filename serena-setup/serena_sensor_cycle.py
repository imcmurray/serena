...
# This will be the main sensor cycle program that will parse through the GrovePi sensors
# and report the data to local Redis
# When this program executes, it will detect if the data structure in REDIS needs to be created
# ism April 6th 2017
